...
/*      pathu                           pathc                           interval        signal */
        { PATH("sb_timedate"),          NULL,                           30,             1},
        { PATH("sb_battery"),            PATH("volume_button.sh"),       0,              2},
        { PATH("sb_cpu"),          PATH("cpu_temp_button.sh"),     1,              4},
        { PATH("sb_disk"),           PATH("battery_button.sh"),      30,             3},
        { PATH("sb_memory"),           PATH("battery_button.sh"),      30,             3},
        { PATH("sb_forecast"),           PATH("battery_button.sh"),      30,             3},
        { PATH("sb_spotify"),           PATH("battery_button.sh"),      30,             3},
};
